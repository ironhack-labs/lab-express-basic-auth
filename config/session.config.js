...
module.exports = app => {
    ...
    app.use(
        session({
            ...
            cookie: {
                sameSite: process.env.NODE_ENV === 'production' ? 'none' : 'lax', // https://web.dev/samesite-cookies-explained/ // en desarrollo lax, en produccion none (para poder utlizar por ej Cloudinary) 
            ...
            store: MongoStore.create({
                mongoUrl: process.env.MONGODB_URI || 'mongodb://localhost/user-auth'
            })
        })
    );
};