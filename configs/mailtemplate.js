module.exports.generateTemplate = (token) => {
    ...
    @media only screen and (max-width:480px) {
      ...
      <img
         alt="" height="auto" src="https://i.imgur.com/H5Hoc8K.jpg" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
      />
      ...
      >
        <tbody>
              ...
              <tr>
                <td
                   align="left" style="font-size:0px;padding:10px 25px;padding-top:50;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;"
                >
                  
      <div
         style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:45px;font-weight:bold;line-height:1;text-align:left;color:#ff0a4d;"
      >Welcome to WireIn!</div>
      ...
      <div
         style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:22px;line-height:1;text-align:left;color:##000000.;"
      ><span style="color:#9acd32">Dear friend,</span><br /><br /> Welcome to WireIn.</div>
      ...
      <div
         style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:left;color:#000000.;"
      >We&apos;re really excited you&apos;ve decided to give us a try. So let's the party begin! You just have to click here to activate your account.</div>
      ...
      >
        <tr>
          ...
          >
            <a
              href="${process.env.HOST || `http://localhost:${process.env.PORT || 3000}`}/activate/${token}" style="display:inline-block;background:##9acd32;color:#ff0a4d;font-family:open Sans Helvetica, Arial, sans-serif;font-size:22px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;"
            >
              Activate
            </p>
          </td>
