...
// the session middleware handles all things for us regarding the session,
// i.e. creating the session, setting the session cookie and creating
// the session object in the request object
