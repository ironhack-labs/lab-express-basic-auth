...
app.use(session({
  ...
  secret: "secret is different for this app",
  //saveUninitialized and "resave" are here just to avoir error messages
  saveUninitialized: true,
  resave: true,
  //use "connect-mongo" to store session informationinside MongoDB
...
app.locals.title = 'Express - Basic Authorization';
