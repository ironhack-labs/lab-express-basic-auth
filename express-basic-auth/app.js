...
mongoose
  .connect(
    "mongodb://localhost/express-basic-auth",
...
app.use(
  session({
    ...
    // "saveUninitialized" and "resave" are here just to avoid error messages
...
app.use((req, res, next) => {
  // make flash messagess accessible inside hbs files as "messages"
