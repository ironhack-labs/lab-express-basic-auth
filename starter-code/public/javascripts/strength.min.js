(function(e, t, n, r) {
  ...
  o.prototype = {
    init: function() {
      ...
      e('input[type="text"][data-password="' + thisid + '"]').bind(
        "keyup keydown",
        function(t) {
          thisval = e(
          ...
          console.log(thisval);
          e('input[type="password"][data-password="' + thisid + '"]').val(
            thisval
          );
          h(thisval, thisid);
        }
      );
      e(n.body).on("click", "." + this.options.strengthButtonClass, function(
        t
      ) {
        t.preventDefault();
        ...
        if (d) {
          ...
          e('input[type="password"][data-password="' + thisid + '"]')
            .show()
            .focus();
          e('a[data-password-button="' + thisid + '"]')
            .removeClass(thisclass)
            .html(v);
          d = false;
        } else {
          e('input[type="text"][data-password="' + thisid + '"]')
            .show()
            .focus();
