(function(e, t, n, r) {
    ...
    var i = "strength",
        s = { strengthClass: "strength", strengthMeterClass: "strength_meter", strengthButtonClass: "button_strength", strengthButtonText: "Show Password", strengthButtonTextToggle: "Hide Password" };
    o.prototype = {
        init: function() {
            function c(e, t) { return t / e * 100 }

            function h(e, n) {
                if (e.length > 8) { t = 1 } else { t = 0 }
                if (e.match(u)) { r = 1 } else { r = 0 }
                if (e.match(a)) { i = 1 } else { i = 0 }
                if (e.match(f)) { s = 1 } else { s = 0 }
                var l = t + r + i + s + o;
            ...
            function p(t, n) {
                ...
                if (t <= 1) {
                    r.removeClass();
                    r.addClass("veryweak").html("very weak")
                } else if (t == 2) {
                    r.removeClass();
                    r.addClass("weak").html("weak")
                } else if (t == 3) {
                    r.removeClass();
